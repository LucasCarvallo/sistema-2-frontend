                ...
                <div class="row g-2">
                    ...
                    <div class="col-sm-2 d-flex align-items-end">
                        <div class="form-check form-switch mb-2">
                            <input class="form-check-input" type="checkbox" id="onlyActiveGrouped" v-model="onlyActive" />
                            <label class="form-check-label small" for="onlyActiveGrouped">Solo activos</label>
                        </div>
                    </div>
