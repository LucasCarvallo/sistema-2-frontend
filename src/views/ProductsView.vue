          ...
          <thead class="table-light">
            <tr>
              ...
              <th class="th-sortable" @click="sort('categoria')">
                Categoría <i :class="['bi', sortIcon('categoria'), 'sort-icon ms-1', { 'is-active': sortKey === 'categoria' }]"></i>
              </th>
              <th class="th-sortable" @click="sort('precio')">
                Precio <i :class="['bi', sortIcon('precio'), 'sort-icon ms-1', { 'is-active': sortKey === 'precio' }]"></i>
              </th>
              <th class="th-sortable" @click="sort('stock')">
                Stock <i :class="['bi', sortIcon('stock'), 'sort-icon ms-1', { 'is-active': sortKey === 'stock' }]"></i>
              </th>
    ...
    >
      ...
      <template #footer>
        ...
        <button class="btn btn-primary" type="button" :disabled="isSaving" @click="save">
          ...
          <i v-else class="bi bi-check-lg me-1"></i>{{ isSaving ? 'Guardando…' : editingId ? 'Guardar cambios' : 'Crear producto' }}
        </button>
      </template>
    </AppModal>
