...
/* Light */
.theme-preview--light .theme-preview__navbar  { background: #212529; }
.theme-preview--light .theme-preview__sidebar { background: #343a40; }
.theme-preview--light .theme-preview__content { background: #f8f9fa; }
.theme-preview--light .theme-preview__line    { background: #adb5bd; }

/* Dark */
.theme-preview--dark .theme-preview__navbar  { background: #1a1d20; }
.theme-preview--dark .theme-preview__sidebar { background: #212529; }
.theme-preview--dark .theme-preview__content { background: #2c3034; }
.theme-preview--dark .theme-preview__line    { background: #6c757d; }

/* Slate */
.theme-preview--slate .theme-preview__navbar  { background: #0c1526; }
.theme-preview--slate .theme-preview__sidebar { background: #0f172a; }
.theme-preview--slate .theme-preview__content { background: #1e293b; }
.theme-preview--slate .theme-preview__line    { background: #3b82f6; }
</style>
